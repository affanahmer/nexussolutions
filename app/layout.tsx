...
export const metadata: Metadata = {
  title: "ASCEND | UK B2B Digital Growth & AI Solutions Agency",
  description:
    "ASCEND drives UK business growth through cutting-edge digital marketing, custom web development, and AI-powered automation. Book a free growth call today.",
  keywords:
